...
// ── put the font in your index.html <head> instead:
    ...
    >
      ...
      <AnimatePresence>
        {phase !== "card" && (
          <motion.div
            key="envelope"
            exit={{ opacity: 0, scale: 0.8, y: 50, transition: { duration: 0.5, ease: "easeIn" } }}
            className="relative"
            style={{ width: EW, height: EH, perspective: "900px" }}
          >
            {/* z-10 back panel */}
            <div
            ...
            <div
              ...
              style={{ zIndex: 30, background: ENVELOPE_BG }}
            >
              <FoldLines />
            </div>
            ...
            <motion.div
              ...
              style={{ height: "62%", transformOrigin: "top center", clipPath: FLAP_CLIP, zIndex: 40 }}
            ...
            >
              <div
                ...
                style={{
                  clipPath: FLAP_CLIP,
                  background: "linear-gradient(180deg, #c59535 0%, #b08328 65%, #987018 100%)",
                }}
              />
              <div
                ...
                <div className="flex justify-center gap-8 mb-4">
                  {[
                    ...
                    <div key={label} className="text-center">
                      <p
                        className="tracking-[0.22em] uppercase text-amber-500 mb-0.5"
