...
export const WeddingPlans: Plan[] = [
  ...
  },
  {
    ...
    days: [
      { date: "02 Dec", activity: "Arrival & Taj Mahal Day Trip" },
      { date: "03 Dec", activity: "Fly to Jorhat" },
      { date: "04 Dec", activity: "5PM: Mehendi & Shoori" },
      { date: "05 Dec", activity: "Majuli Island River Crossing" },
      { date: "06 Dec", activity: "2PM: Reception & Rituals" },
      { date: "07 Dec", activity: "Kaziranga Safari & Nature" },
